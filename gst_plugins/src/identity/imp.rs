...
impl Identity {
    ...
    fn sink_chain(
        ...
        gst::gst_log!(CAT, obj: pad, "Handling buffer {:?}", buffer);
    ...
    fn sink_event(&self, pad: &gst::Pad, _element: &super::Identity, event: gst::Event) -> bool {
        gst::gst_log!(CAT, obj: pad, "Handling event {:?}", event);
    ...
    fn sink_query(
        ...
        gst::gst_log!(CAT, obj: pad, "Handling query {:?}", query);
...
impl ElementImpl for Identity {
    ...
    fn change_state(
        ...
        gst::gst_trace!(CAT, obj: element, "Changing state {:?}", transition);
